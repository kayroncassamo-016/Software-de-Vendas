...

{
  ...
  useEffect(() =>{
   ...
   if (cliente)
   {
        ...
        setProvincia(cliente.endereco?.provincia??'');
        setLimiteCredito(cliente.financeiro?.limite_credito??'');
        setSelectedFormaPagamento(cliente.financeiro?.forma_pagamento??'');
  ...
  async function handleActualizarCliente()
  {
    ...
    {    setVisible(false)
        ...
        await api.put(`/clientes/${cliente?.id}`,
          ...
          Alert.alert('Cliente actualizado com sucesso!',)
    }
    catch(err:any)
    {
    ...
    return (
        ...
        onDismiss={()=> setVisible(false)}
           style={{ backgroundColor: '#fff'}}> 
            ...
            Actualize o cliente seleccionado
              </Dialog.Title>
