           ...
           <View style={{gap:10}}>
            ...
            <View style={{gap:10}}>
              <Text style={styles.dialogTextStyle}>Nome do documento:</Text>
                  <Select
                    label=""
                    placeholder="Selecione o nome de documento"
                    options ={nomeDocumento.map(nome => ({
                      label: nome,
                      value: nome
                    }))}
                    selectedValue={selectedNomeDocumento}
                    onValueChange={setSelectedNomeDocumento}
                  />
            </View>
